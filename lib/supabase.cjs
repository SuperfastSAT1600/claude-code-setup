...
async function setupSupabase(rl, platformInfo) {
  ...
  // Step 6: Supabase MCP Server (Auto-enabled)
  ...
  console.log(color('  1. Start your Supabase local dev server: supabase start', 'dim'));
  console.log(color('  2. In a regular terminal (not IDE), run: claude /mcp', 'dim'));
  console.log(color('  3. Select "supabase" → "Authenticate"', 'dim'));
  console.log('');

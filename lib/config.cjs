...
const CONFIG = {
  ...
  directoriesToCreate: [
    ...
    '.claude/plans',                // Required for spec-driven TDD workflow
    '.claude/user',                 // Required for error logging (task-protocol.md)
    '.claude/user/agent-errors',    // Required for subagent error logging
    '.claude/health',               // Required for health changelog
  ],

  // Seed files created with initial content if they don't exist
  seedFiles: [
    { path: '.claude/user/errors.md', content: '# Error Log\n\n' },
    { path: '.claude/user/changelog.md', content: '# System Changelog\n\n' },
    { path: '.claude/health/changelog.md', content: '# Health Changelog\n\n' },
  ],
};
